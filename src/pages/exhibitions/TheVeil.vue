...
<template>
    <div class="flex flex-col grow">
        ...
        <div class="container mx-auto grid md:grid-cols-2 gap-6 px-3">
            <img
                src="/images/veil/veil-1-nomark-min.png"
            ...
            <div id="press-release">
                <div class="grid md:grid-cols-2 grid-cols-1 gap-6 mb-6">
                    <div class="flex justify-between">
                        ...
                        <a
                            href="/docs/veil/veil-press-release.pdf"
                ...
                <div>
                    ...
                    <p>
                        Functional theories of perception raise a distinction between beliefs and causes: a common example is that of a frog hunting flies. The frog hunting flies does not need to have any particular beliefs about what flies <em>are</em>, but simply needs to track the stimulus of moving black dots. In an environment where most moving black dots are flies, then the presence of this stimulus is sufficient to cause the frog to react to it, whether the dots are actually flies or not.
                    </p>
                    <p>
