            ...
            <div id="press-release">
                <div class="grid md:grid-cols-2 grid-cols-1 gap-6 mb-6">
                    <div class="flex justify-between">
                        ...
                        <a
                            href="/docs/brain-worms/brain-worms-release.pdf"
