        ...
        <div class="container mx-auto py-8 px-3 md:justify-between flex md:flex-row flex-col md:items-center">
            <div class="justify-between flex items-center">
                <router-link :to="{ name: 'home' }" @click="closeMenu()">
                    <h1 class="text-4xl mb-0 font-germania-one text-sky-900" :class="{ 'text-white': $route.name == 'home'}">Twelve Ten</h1>
                </router-link>

                <div class="md:hidden block text-xl" @click="toggleMenu()">
                    <span v-if="!menuActive"><i class="las la-bars" :class="{ 'text-white': $route.name == 'home'}"></i></span>
                    <span v-if="menuActive"
                        ><i class="las la-times" :class="{ 'text-white': $route.name == 'home' && menuActive }"></i
                    ></span>
                </div>
            </div>
            ...
            <div
                ...
                :class="[{ hidden: !menuActive }, { '!text-white': $route.name == 'home'}, { 'text-white': $route.name == 'home' && menuActive }]"
            >
                <router-link
